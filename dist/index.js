...
Component.options.__file = "src/Autocomplete.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0e3ab061", Component.options)
  } else {
    hotAPI.reload("data-v-0e3ab061", Component.options)
  }
...
var render = function() {
  ...
  return _c("div", { staticClass: "relative" }, [
    _c("input", {
      ...
      attrs: {
        type: "text",
        placeholder: [_vm.selected ? "" : _vm.placeholder]
      },
          ...
          [
            _vm._t(
              ...
              [
                _vm._v(
                  "\n            " +
                    _vm._s(_vm.selected[_vm.keyName]) +
                    "\n        "
                )
              ],
    ...
    _c(
      ...
      [
        _vm.matches.length > 0
          ? _vm._l(_vm.matches.slice(0, 10), function(match, index) {
              return _c(
                "a",
                {
                  key: index,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0e3ab061", module.exports)
  }
}
